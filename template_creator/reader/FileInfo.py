...
class FileInfo:
    def __init__(self, location, directory, file, handler_line, handler_lines, strategy, other_file_lines, zip_file=None):
    ...
    def build(self):
        ...
        permissions = self.strategy.find_role(all_file_lines)
