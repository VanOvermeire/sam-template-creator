...
class TestCoordinator(unittest.TestCase):
    ...
    @patch('middleware.transformer')
    @patch('writer.yaml_writer.write')
    @patch('reader.directory_scanner.find_lambda_files_in_directory')
    @patch('reader.directory_scanner.guess_language')
    @patch('util.template_checks.check_template_name')
